...
//        }
        ...
        Integer orderPayStatus = Orders.PAID;
        ...
        log.info("模拟调用微信支付接口，生成预支付交易单，订单号：{}", orderNumber);
...
//                    new BigDecimal(0.01));//原订单金额
    ...
    public void rejection(OrdersRejectionDTO ordersRejectionDTO) throws Exception {
        ...
        Integer orderPayStatus = ordersDB.getPayStatus();
        Orders orders = new Orders();
        if (Objects.equals(orderPayStatus, Orders.PAID)) {
//            //用户已支付，需要退款
